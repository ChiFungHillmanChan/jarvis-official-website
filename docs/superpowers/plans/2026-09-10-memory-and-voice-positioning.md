...
| Memory privacy    | Saved facts are stored locally and included in model prompts                                  | “Stored on your Mac. Included in requests to your selected AI provider.”    | Memory never leaves the device when cloud inference is used                                                         |
